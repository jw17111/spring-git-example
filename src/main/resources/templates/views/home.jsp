        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        Curabitur sed bibendum neque, at congue ipsum. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus mattis a mauris.
                    </div>
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                        Integer commodo euismod accumsan. Mauris bibendum ante at aliquet, eu dictum orci porttitor. Mauris cursus cursus.
                    </div>
                </div>
                ...
                <div class="alert alert-info">
                    <ol>
                        <li>Donec vitae suscipit leo. Mauris arcu felis, eleifend id porta.</li>
                    </ol>
                </div>
            </div>
        </div>
